...
**동작**:
- Adoptium Eclipse Temurin JDK 8u422 다운로드
- `env/jdk/` 경로에 압축 해제
...
```bash
echo $JAVA_HOME
# /path/to/PubcTestApi/env/jdk/jdk8u422-b05

echo $JBOSS_HOME
# /path/to/PubcTestApi/env/jboss/jboss-eap-7.4
...
```bash
which java
# /path/to/PubcTestApi/env/jdk/jdk8u422-b05/bin/java 여야 함

echo $JAVA_HOME
# /path/to/PubcTestApi/env/jdk/jdk8u422-b05 여야 함
```
...
### Q3. macOS Apple Silicon (M1/M2)에서 작동하나요?

**A**: 네, 자동으로 ARM64 JDK를 다운로드합니다.
